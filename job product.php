...
<?php include '../../footer-main.php'; ?>@ -0,0 +1,190 @@
<?php
    ...
    <div class="lg:flex gap-5">
        <div class="grow space-y-5">
            <div class="panel">
                <form action="">
                    <div>
                        ...
                        <input type="text" placeholder="Enter job Domain" class="form-input" />
                    </div>
                    <div class="mt-5">
                        <label>Job Description</label>
                        <div id="editor">
                        <textarea placeholder="Enter job description" rows="4" class="form-textarea"></textarea>
                    </div>
                </form>
            </div>
            <div class="hidden lg:flex justify-end gap-4">
                ...
                <button type="submit" class="btn btn-primary">Submit</button>
                            ...
                            <h1>welcome to All in one placement...</h1>
                            <br />
            ...
            <div class="panel p-0">
                <div class="p-4 border-b dark:border-[#191e3a] font-bold text-base dark:text-white">upload document</div>
                <form action="" class="space-y-5 p-4">
                    <div class="grid sm:grid-cols-2 gap-4">
                        <label class="border-2 border-dashed border-primary/50 bg-primary/5 flex items-center justify-center flex-col gap-4 relative p-5">
                            ...
                            <h5 class="text-lg font-bold text-center">Drag & drop resume here</h5>
                        ...
                        <label class="border-2 border-dashed border-primary/50 bg-primary/5 flex items-center justify-center flex-col gap-4 relative p-5">
                            ...
                            <h5 class="text-lg font-bold text-center">Drag & drop course certificate here</h5>
                            <input type="file" class="absolute opacity-0 z-[1] cursor-pointer">
                        </label>
                    </div>
                </form>
                ...
                <form action="" class="space-y-8 p-4">
                    <div class="grid sm:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" placeholder="Enter Your sweet name" class="form-input" />
                        </div>
                        <div>
                            <label>last company</label>
                            <input type="text" placeholder="Enter name of past companies" class="form-input" />
                        </div>
                    </div>
                    <div class="grid sm:grid-cols-2 xl:grid-cols-4 gap-6">
                        <div>
                            <label>overall Experience</label>
                            <input type="text" placeholder="Experience in months" class="form-input" />
                        </div>
                        <div>
                            ...
                            <div class="flex">
                                ...
                                <input type="text" placeholder="salary in rupees" class="form-input ltr:rounded-l-none rtl:rounded-r-none" />
                            </div>
                        </div>
                    ...
                    <div class="grid sm:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" placeholder="Enter the Domain" class="form-input" />
                        </div>
                    </div>
                    <div>
                        <label>Job Description</label>
        ...
        <div class="shrink-0 lg:max-w-xs w-full mt-5 lg:mt-0">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-5">
                ...
                <div class="panel p-0">
                    <div class="p-4 border-b dark:border-[#191e3a] font-semibold text-base dark:text-white">Job Categories</div>
                    <form action="" class="space-y-5 p-4">
                        <div>
                            <label class="">Select job category</label>
                            <select class="form-select">
                ...
                <div class="panel p-0">
                    <div class="p-4 border-b dark:border-[#191e3a] font-semibold text-base dark:text-white">job Short Description</div>
                    <form action="" class="space-y-5 p-4">
                        <div>
